    ...
    switch (reader.TokenType)
    {
      case JsonTokenType.String:
        ...
        if (string.IsNullOrEmpty(stringValue))
          return UserRoles.User; // Default to User for empty strings
...
/// <summary>
/// Custom JSON converter for nullable UserRoles enum that supports both string and integer values
/// </summary>
public class NullableUserRolesJsonConverter : JsonConverter<UserRoles?>
{
  public override UserRoles? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
    switch (reader.TokenType)
